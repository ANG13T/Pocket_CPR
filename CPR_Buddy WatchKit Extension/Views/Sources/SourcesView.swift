        ...
        ScrollView {
            VStack(spacing: 15) {
                ...
                VStack {
                    ...
                    Link("https://www.redcross.org/take-a-class/cpr/performing-cpr/cpr-steps", destination: URL(string: "https://www.redcross.org/take-a-class/cpr/performing-cpr/cpr-steps")!)
                }
                
                VStack {
                    Text("2. Child & Baby CPR").bold()
                    Text("American Red Cross Organization").bold()
                    Link("https://www.redcross.org/take-a-class/cpr/performing-cpr/child-baby-cpr", destination: URL(string: "https://www.redcross.org/take-a-class/cpr/performing-cpr/child-baby-cpr")!)
                }
                
                VStack {
                    Text("3. Hands-Only CPR").bold()
                    Text("Tarrant County College").bold()
                    Link("https://www.tccd.edu/about/emergency-information/know-what-to-do/medical-emergencies/cpr/#:~:text=Give%20compressions%20by%20using%202,cause%20the%20chest%20to%20rise.", destination: URL(string: "https://www.tccd.edu/about/emergency-information/know-what-to-do/medical-emergencies/cpr/#:~:text=Give%20compressions%20by%20using%202,cause%20the%20chest%20to%20rise.")!)
                }
                
                VStack {
                    Text("4. What is CPR?").bold()
                    Text("American Heart Association").bold()
                    Link("https://cpr.heart.org/en/resources/what-is-cpr", destination: URL(string: "https://cpr.heart.org/en/resources/what-is-cpr")!)
                }
